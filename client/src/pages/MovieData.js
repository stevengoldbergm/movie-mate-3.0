            ...
            <main className=" is-fullwidth m-0 p-0 py-6 has-background-info">
                <section id="main-data" className="columns">
                    ...
                    <div className="column is-multiline is-10 p-5 m-0 is-justify-content-space-around is-justify-content-center-mobile has-background-white is-align-items-center">
                        <div className="columns columnis-multiline is-12 p-5 m-0 is-justify-content-space-around is-justify-content-center-mobile has-background-white is-align-items-center reverse-columns-mobile">
                        ...
                        <div className="columns is-multiline is-justify-content-space-between m-0 p-0">
                            ...
                            <div className="column is-6 is-12-mobile p-1">
                                ...
                                {movieData && 
                                <div id="movie-data" className="column is-justify-content-space-around is-flex is-flex-direction-column">
                            ...
                            <div className="column is-6 is-12-mobile p-1">
                                ...
                                {movieData && 
                                <div id="movie-data" className="column is-justify-content-space-around is-flex is-flex-direction-column">
                                    <h1 className="title is-size-6 subtitle courier-new">{movieData.Actors} </h1>
                                </div>
                                }
                                <h1 className="column is-fullwidth has-background-info has-text-white is-size-5 p-0 pl-3 is-roundeds">
                                        Directed By
                                ...
                                {movieData && 
                                <div id="movie-data" className="column is-justify-content-space-around is-flex is-flex-direction-column">
                                    <p className="subtitle is-size-6 courier-new">{movieData.Director} </p>
                                </div>
                                }
                                <h1 className="column is-fullwidth has-background-info has-text-white is-size-5 p-0 pl-3 is-roundeds">
                                        Details
                                ...
                                {movieData && 
                                <div id="movie-data" className="column is-justify-content-space-around is-flex is-flex-direction-column">
                                    <p className="is-size-6 fantasy">Rated: {movieData.Rated} </p>
                                    <p className="is-size-6 fantasy">Release Date: {movieData.Released}</p>
                                </div>
                                }
                                <h1 className="column is-fullwidth has-background-info has-text-white is-size-5 p-0 pl-3 is-roundeds">
                                        Reviews
                                ...
                                {movieData && 
                                <div id="movie-data" className="column is-justify-content-space-around is-flex is-flex-direction-column">
                                    <p className="is-size-6 fantasy">IMDB: {movieData.imdbRating}</p>
                                    <p className="is-size-6 fantasy">Rotten Tomatoes: {rtScore}</p>
                                    <p className="is-size-6 fantasy">Metacritic: {movieData.Metascore}</p>
                                    <hr />
