...
mutation CreateReview($movieId: String!, $reviewText: String!, $movieName: String!, $reviewScore: String!) {
  createReview(movie_id: $movieId, review_text: $reviewText, movie_name: $movieName, review_score: $reviewScore) {
    _id
    user_id
    movie_id
    review_score
